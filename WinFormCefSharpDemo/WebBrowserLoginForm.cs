 ...
 */
    ...
    public partial class WebBrowserLoginForm : Form
    {
        public WebBrowserLoginForm()
        {
            this.InitializeComponent();
        }

        private void WebBrowserLoginForm_Shown(object sender, EventArgs e)
        {
            Application.DoEvents();
            MemoryStream HTMLStream = this.GetHTMLStream();
            if (HTMLStream == null)
            {
                MessageBox.Show("空的网页流，程序即将退出...");
                Application.Exit();
            }
            this.MainWebBrowser.DocumentStream = HTMLStream;
            this.Text = this.MainWebBrowser.DocumentTitle;
        ...
        public void CheckLogin(string UserName, string Password)
        {
            ...
            if (UserName == "123" && Password == "456")
            {
                ...
                this.MainWebBrowser.Document.InvokeScript("LoginSuccessfully",
